...
- 📝 Create a new Java class file named **Book.java**  
- 🔖 Define attributes such as `id`, `title`, `author`, `price`, and `quantity`  
- ⚙️ Use a **parameterized constructor** to initialize these attributes  
- 🔁 Add **getter and setter methods** to access and modify values  
- 🧾 Override the `toString()` method to display book details neatly when printed  
